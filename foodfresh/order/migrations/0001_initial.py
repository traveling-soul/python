    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_method', models.SmallIntegerField(choices=[(1, '货到付款'), (2, '微信支付'), (3, '支付宝'), (4, '银联支付')], default=3)),
                ...
                ('addr', models.ForeignKey(on_delete=True, to='user.Address', verbose_name='地址')),
        ...
        migrations.AddField(
            model_name='ordergoods',
            name='sku',
            field=models.ForeignKey(on_delete=True, to='food.GoodsSKU', verbose_name='商品SKU'),
        ),
    ]
